...
@pytest.mark.parametrize(
    ...
    [
        [1, {}, 422],
        [1, {'description': 'something else'}, 422],
        [999, {'title': 'something', 'description': 'something else'}, 404],
        [1, {'title': '1', 'description': 'bar'}, 422],
        [1, {'title': 'foo', 'description': '2'}, 422],
        [0, {'title': 'something', 'description': 'something else'}, 422],
    ]
)
